...
{
    "name": "Laboratorio de Diseño IHCE",
    "version": "1.0",
    "depends": ["base",'company_ihce'],
    "author": "Grupo Altegra",
    "category": "Custom Modules",
    "description": "Área de laboratorio de diseño",
    "data" :[
        'security/groups.xml',
        'security/ir.model.access.csv',
        'security/sequence.xml',
        'security/access_rule.xml',
        'views/company_list_view.xml',
        'views/services_laboratory.xml',
        'wizard/detained_services.xml',
        ],
    "demo" : [
    ],
    'test': [],
